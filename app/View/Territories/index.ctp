<div class="territories index">
	...
	<tr>
		...
		<td class="actions">
			...
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $territory['Territory']['id']), array('confirm' => __('Are you sure you want to delete # %s?', $territory['Territory']['id']))); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</tbody>
