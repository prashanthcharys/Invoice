<div class="customerAddresses index">
	...
	<tr>
		...
		<td class="actions">
			...
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $customerAddress['CustomerAddress']['id']), array('confirm' => __('Are you sure you want to delete # %s?', $customerAddress['CustomerAddress']['id']))); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</tbody>
